...
define( 'DB_NAME', getenv_docker('CLASSICPRESS_DB_NAME', 'wordpress') );

/** Database username */
define( 'DB_USER', getenv_docker('CLASSICPRESS_DB_USER', 'example username') );

/** Database password */
define( 'DB_PASSWORD', getenv_docker('CLASSICPRESS_DB_PASSWORD', 'example password') );
 ...
 */
$table_prefix = getenv_docker('CLASSICPRESS_TABLE_PREFIX', 'wp_');
 ...
 */
define( 'WP_DEBUG', !!getenv_docker('CLASSICPRESS_DEBUG', '') );
